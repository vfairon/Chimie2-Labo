...
ax2.plot(x,polytoplot_H2(x),label="Evolution de la vitesse de [H2] en fonction de la Tension")
ax2.plot(x,polytoplot_O2(x),label="Evolution de la vitesse de [O2] en fonction de la Tension")
...
plt.title("Evolution de la vitesse du rendement faradique pour differentes tensions")
ax3.scatter(Tension,evolution_rendement_faradique_H2)
ax3.scatter(Tension,evolution_rendement_faradique_O2)
ax3.plot(x,polytoplot_rendement_faradique_H2(x),label="Evolution du rendement faradique de [H2] en fonction de la tension")
ax3.plot(x,polytoplot_rendement_faradique_O2(x),label="Evolution du rendement faradique de [O2] en fonction de la tension")
ax3.legend()
plt.xlabel("Tension [V]")
...
ax4.plot(x,polytoplot_rendement_energetique(x),label="Evolution du rendement énergétique en fonction de la tension")
ax4.legend()
plt.xlabel("Tension [V]")
plt.ylabel("Rendement Faradique")
plt.show()
